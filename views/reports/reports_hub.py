...
_CARDS = [
    ...
    ("⚖",  "Weight Variance",    "Received vs sold weight (kg) for weighed items", "WeightVarianceReport"),
...
def _open_report(key: str, wins: list):
    ...
    _FACTORIES = {
        ...
        "WeightVarianceReport": ("views.reports.weight_variance_report", "WeightVarianceReport"),
