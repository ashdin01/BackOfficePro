"""Users settings screen — user management and sign-in options."""
...
class UsersScreen(QWidget):
    ...
    def _build_ui(self):
        ...
        btn_add.setStyleSheet(
            ...
            f"border-radius:4px;padding:0 12px;font-weight:bold;}}"
        ...
        self._btn_toggle.setStyleSheet(
            f"QPushButton{{color:{styles.CLR_DANGER_ALT};border:1px solid {styles.CLR_DANGER_ALT};"
            f"border-radius:4px;padding:0 12px;background:transparent;}}"
    ...
    def _save(self):
        ...
        QMessageBox.information(self, "Saved", "Users settings saved successfully.")
        self.close()
    ...
    def _reset_pin(self):
        ...
        if not ok or not pin:
            return
        try:
            user_ctrl.set_pin_by_id(uid, pin)
